        ...
        <section class="vbox wrapper_form">
            ...
            <section class="scrollable wrapper">
                ...
                <div class="tab-content">
                    <form class="form-horizontal apple" name="frmeditcategory" id="frmeditcategory"  method="post" enctype="multipart/form-data">
                        <div class="form-horizontal-div">
                            ...
                            <div class="divsize" style="<?php echo (isset($this->params['named']['parent']) && $this->params['named']['parent']!='')?'display: block;':'display: none;'?>" >
                                <div class="form-group m-t-lg1" >
                                ...
                                <div class="form-group m-t-lg1" >
                                    ...
                                    <div class="col-sm-4">
                                        <div class="checkbox">
                                            <label class="checkbox-custom" style="font-weight:light;font-size:13px;">
                                            <input type="checkbox" id="color" class="same_above" name="data[Category][color]" value="yes" <?php echo (isset($this->data['Category']['color']) && $this->data['Category']['color']=='yes')?'checked':'' ?> /><i class="icon-unchecked"></i> </label>
                                ...
                                <div class="form-group m-t-lg1" >
                                    ...
                                    <div class="col-sm-4">
                                        <div class="checkbox">
                                            <label class="checkbox-custom" style="font-weight:light;font-size:13px;">
                                            <input type="checkbox" id="patch" class="same_above" name="data[Category][patch]" value="yes" <?php echo (isset($this->data['Category']['patch']) && $this->data['Category']['patch']=='yes')?'checked':'' ?> /><i class="icon-unchecked"></i> </label>
                                            <b><?php echo PATCH_NOTE;?></b>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group m-t-lg1" style="<?php //echo (isset($this->params['named']['parent']) && $this->params['named']['parent']!='')?'display: block;':'display: none;';?> ">
                            ...
                            <input type="hidden" name="oldimage" id="oldimage" value="<?php echo $this->data['Category']['imagename'];?>">
                            <?php  if(isset($this->data['Category']['imagename']) && $this->data['Category']['imagename']!='' && is_file(UPLOAD_FOLDER.'category/100x100/'.$this->data['Category']['imagename'])) {?>
                            <div class="form-group m-t-lg1 dis_image">
                                <label class="col-sm-2 control-label"></label>
                                <div class="col-sm-4">                                                    
                                    <img src="<?php echo DISPLAY_URL_IMAGE.'category/100x100/'.$this->data['Category']['imagename'];?>" title="">
                                </div>
                            </div>
                            <?php }?>
