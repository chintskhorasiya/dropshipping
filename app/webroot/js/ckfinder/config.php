...
include_once($_SERVER["DOCUMENT_ROOT"]."/dropshipping/app/webroot/constant.php");

$baseUrl = CKEDITOR_URL;
//$baseUrl = 'http://localhost/joondal/app/webroot/js/ckfinder/userfiles/';
